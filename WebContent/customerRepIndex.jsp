...
<body>
	...
	<li><a href="manageAircrafts.jsp">Add, Edit, or Delete
			Aircrafts</a></li>
	<br />
	<li><a href="manageAirports.jsp">Add, Edit, or Delete Airports</a>
	</li>
	<br />
	<li><a href="manageFlights.jsp">Add, Edit, or Delete Flights</a></li>
	<br />
	<li><a href="getWaitlist.jsp">Get list of standby passengers
			for a given Flight</a></li>
	<br />
