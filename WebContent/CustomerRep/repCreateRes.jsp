...
<html>
	...
	<form action="searchResults.jsp" method="POST">
		...
		String uName=request.getParameter("repSelUser");
		session.removeAttribute("custUName");
		session.setAttribute("custUName", uName);
		...
		<br/>
		<a href="viewReservations.jsp">View Reservations for Given Customer</a>
		</form>
