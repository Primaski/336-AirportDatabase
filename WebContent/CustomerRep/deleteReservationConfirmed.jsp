...
<body>
	<%
		try {
			...
			if (slatedForDeletion == null || slatedForDeletion == "") {
				out.println("Oops! Error retrieving parameter.");
				return;
			}
			...
			String getFlightInfoQuery = "SELECT FlightID, flightClass FROM Tickets WHERE TicketID = '" + ticketNo
					+ "'";
			String deleteFromBuysQuery = "DELETE FROM Buys WHERE TicketID = '" + ticketNo + "'";
			String deleteFromTicketsQuery = "DELETE FROM Tickets WHERE TicketID = '" + ticketNo + "'";
			...
			try {
				incFlightCapacityQuery = "UPDATE Flights SET "
						...
						+ "Capacity + 1 WHERE FlightID = '" + flightID + "'";
	...
	<h1>Success!</h1>
	<h3>
		Successfully deleted your reservation from the database. Please check
		<a href="viewReservations.jsp">My Reservations</a> to confirm!
	</h3>
</body>
</html>
